<nav class="navbar navbar-expand-lg navbar-dark primary-background ">
  <a class="navbar-brand" href="index.jsp"><span><i class="fa fa-certificate" style="font-size:24px"></i></span> ThoCodeBlog</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto ">
      <li class="nav-item active">
        <a class="nav-link" href="#"><span class="fa fa-check-square"></span> Learn code with ThoCode <span class="sr-only">(current)</span></a>
      </li>

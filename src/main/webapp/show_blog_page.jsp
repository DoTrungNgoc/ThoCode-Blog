...
<%@page import="com.thocode.blog.dao.UserDao"%>
...
<html>
    <head>
        ...
        <title><%= p.getpTitle()%> || ThoCode Blog </title>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark primary-background">
            <a class="navbar-brand" href="index.jsp"> <span class="fa fa-asterisk"></span>   ThoCode Blog</a>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header primary-background text-white text-center">
                        <h5 class="modal-title" id="exampleModalLabel"> ThoCode Blog </h5>
